...
func NewInitMetaDataMysql(db *gorm.DB) *initMetaData_Mysql {
	return &initMetaData_Mysql{
		db: db,
	}
}

// func NewInitMetaDataMysql(dbConf *global.DBConfig) *initMetaData_Mysql {
...
// func InitMysqlDB(dbConf *global.DBConfig) *gorm.DB {
