...
func NewInitMetaDataPostgres(db *gorm.DB) *initMetaData_Postgres {
...
// func NewInitMetaDataPostgres(dbConf *global.DBConfig) *initMetaData_Postgres {
...
// func InitPostgresDB(dbConf *global.DBConfig) *gorm.DB {
